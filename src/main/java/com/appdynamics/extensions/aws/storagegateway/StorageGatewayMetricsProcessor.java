...
public class StorageGatewayMetricsProcessor implements MetricsProcessor {
    ...
    private static final String[] DIMENSIONS = {"GatewayId", "GatewayName"};

    private List<MetricType> metricTypes;

    private Pattern excludeMetricsPattern;

    public StorageGatewayMetricsProcessor(List<MetricType> metricTypes,
    ...
    public Map<String, Double> createMetricStatsMapForUpload(NamespaceMetricStatistics namespaceMetricStats) {
        ...
        dimensionToMetricPathNameDictionary.put(DIMENSIONS[0], "Gateway Id");
        dimensionToMetricPathNameDictionary.put(DIMENSIONS[1], "Gateway Name");
